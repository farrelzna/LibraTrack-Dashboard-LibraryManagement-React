...
export default function Sidebar() {
  ...
  return (
    ...
    <div className="relative flex">
      <div className="absolute top-4 transition-all duration-300 cursor-pointer" style={{ left: isOpen ? '10.3rem' : '1.6rem', top: isOpen ? '2rem' : '1rem' }}>
        <button
        ...
        <div className="py-6 flex justify-center">
          <div className="text-xl font-semibold text-gray-800 h-10 flex items-center justify-center">
            {isOpen ? (
              ...
              <div className="flex justify-center text-center align-center mt-10 transition ">
